...
public class Constants {
    public Constants(){}
    // Root page
//    public static String WEBAPP_URL = "https://ashdevtools.netlify.com/#/auth/signin";
    public static String WEBAPP_URL = "https://opol-fred.mybluemix.net/#/auth/signin";
    public static String WEBAPP_HOST = "andrews.com"; // used for checking Intent-URLs
