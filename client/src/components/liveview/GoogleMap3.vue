<template>
  <div id="root">
    <v-btn color="success" @click="route()">Success</v-btn>
...
// this.$refs.gmap.$on('zoom_changed', someFunc)
  ...
  export default {
    data () {
      return {
        center: {lat: 32.3173168, lng: -95.2474281},
        markers: {},
      sock: {},
      loadedMarkers:[],
      statusText: '',
...
if(value.tid == marker.tid){
 ...
 origin: [-12.044012922866312, -77.02470665341184],
  destination: [-12.090814532191756, -77.02271108990476],
      ...
      vm.sock.onopen = function(){ console.log("Connected websocket");
      ...
      vm.sock.onerror = function(){ console.log("Websocket error"); };
