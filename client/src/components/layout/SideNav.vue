<template>
  <v-navigation-drawer v-if="$_isAuthenticated" id="mainNav" :mini-variant="miniVariant" v-model="leftDrawer" style="overflow: hidden;" mobile-break-point="964" width="250" class="blue-grey darken-4" dark persistent fixed app>
