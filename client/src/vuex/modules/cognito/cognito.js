...
const actions = {
    confirmPassword: function({ commit, state }, { code, pass, username }) {
    ...
    forgotPassword: function({ commit, state }, username) {
        return new Promise((resolve, reject) => {
            let userData = {
                Username: username,
                Pool: state.userPool
    ...
    changePassword: function({ commit, state }, { oldPass, newPass }) {
    ...
    getIdToken: function({ commit, state }) {
    ...
    signIn: function({ commit, dispatch, state }, { username, pass }) {
    ...
    confirmRegistration: function({ commit, state }, { username, code }) {
        let cognitoUser = new CognitoUser({
            Username: username,
            Pool: state.userPool
        })
    ...
    resendConfirmationCode: function({ commit, state }, username) {
        let cognitoUser = new CognitoUser({
            Username: username,
            Pool: state.userPool
        })
    ...
    setUserId: function({ commit, state }) {
    ...
    setUsername: function({ commit, state }) {
        console.log('setting user id...')
        let user = state.userPool.getCurrentUser()
        console.log(user.username)
        return new Promise((resolve, reject) => {
